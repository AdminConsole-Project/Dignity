        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if (data == 0){
                    ...
                    ac_info.children[3].classList.remove("hide");
                    ac_info.children[3].children[0].setAttribute("aria-hidden","false");
                    ...
                    ac_info.children[2].classList.remove("hide");
                    ac_info.children[2].children[0].setAttribute("aria-hidden","false");
